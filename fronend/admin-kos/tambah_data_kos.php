                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="Nama_kos" class="form-control" id="nama" placeholder="Masukkan Nama Kos">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="Fasilitas" class="form-control" id="fasilitas" placeholder="Tuliskan Fasilitas Tersedia">
                        </div>
                        <div class="form-group">
